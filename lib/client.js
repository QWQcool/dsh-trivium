  ...
  factory: (require) => {
    ...
    const I18N = {
      ...
      en: {
        ...
        chipTab: "Chips (whitelist)",
        chipsSetting: "Chips (memory whitelist, off by default)",
        chipsSettingHint: "When on, the Chips tab (memory whitelist) appears next to Conversation / Trajectory immediately. Checked items inject from the next turn (L0, ≤300 tokens). Stored in ~/.dsh/trivium.json and kept across restarts. Nodes stay in .tdb; turning this off does not delete memory. No extra Save click and no restart.",
