...
> 状态：**已随 dsh-trivium@0.4.0 发布**；**0.4.1** 把宿主钉到 `0.1.0-rc.8`；**0.4.2** 芯片条可新增、批量归档 / 删除；**0.4.3** 旧会话「更新检查点」；**0.4.4** 接 TriviumDB 0.7.5 入边 / label 扩邻；**0.4.5** peer 兼容 `0.1.1-rc.2`。第一刀 / 第二刀 / 第三刀完成。内核仍是四工具 + 短地图；本面不替代压缩，不新建聊天窗口。  
