...
> 状态：**已随 dsh-trivium@0.4.0 发布**；**0.4.1** 把宿主钉到 `0.1.0-rc.8`。第一刀 / 第二刀 / 第三刀完成。内核仍是四工具 + 短地图；本面不替代压缩，不新建聊天窗口。  
...
- **记忆芯片**：`.tdb` 里已有的 entity / preference / decision / experience，人勾选后钉进当前会话的下一轮注入。
